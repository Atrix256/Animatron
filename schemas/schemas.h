...
STRUCT_BEGIN(Data, EntityImage, "An image file")
    ...
    STRUCT_FIELD_NO_SERIALIZE(std::vector<Data::ColorPMA>, _rawpixels, std::vector<Data::ColorPMA>(), "The PMA pixels of the loaded image")
    ...
    STRUCT_FIELD_NO_SERIALIZE(std::vector<Data::ColorPMA>, _pixels, std::vector<Data::ColorPMA>(), "The PMA pixels of the resized image")
STRUCT_END()
