...
STRUCT_BEGIN(Data, EntityCubicBezier, "Draw a line")
    STRUCT_FIELD(Point2D, A, Point2D(), "Control Point of Curve")
    STRUCT_FIELD(Point2D, B, Point2D(), "Control Point of Curve")
    STRUCT_FIELD(Point2D, C, Point2D(), "Control Point of Curve")
    STRUCT_FIELD(Point2D, D, Point2D(), "Control Point of Curve")
    STRUCT_FIELD(float, width, 1.0f, "Line width")
